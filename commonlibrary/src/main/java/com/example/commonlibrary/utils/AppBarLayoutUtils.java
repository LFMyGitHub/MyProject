...
public class AppBarLayoutUtils {
    public static void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset, View toolbarOpen,
                                       View toolbarClose, View bgToolbarOpen, View bgToolbarClose,
                                       View bgContent) {
        //垂直方向偏移量
